...
Please submit a cleanly knitted HTML file describing in detail the steps you took along the way, the results of your analysis and most importantly the implications/next steps you would recommend. A selected few of you will report your final results and recommendations next week in class (5 minutes per group) 
...
```{r}
west <- read_lines("/Users/catherineschuster/Desktop/Fall 2021/DS 3001/DS-3001-Main/07_text_mining/DS3001-Lab7/west.txt")
